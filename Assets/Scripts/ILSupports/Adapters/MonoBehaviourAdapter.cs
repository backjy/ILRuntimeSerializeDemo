...
public class MonoBehaviourAdapter : MonoBehaviour, CrossBindingAdaptorType
{
    ILTypeInstance instance;
    ILRuntime.Runtime.Enviorment.AppDomain appdomain;

    public MonoBehaviourAdapter()
    {

    }

    public MonoBehaviourAdapter(ILRuntime.Runtime.Enviorment.AppDomain appdomain, ILTypeInstance instance)
    {
...
public class MonoCrossBindAdaptor : CrossBindingAdaptor
{
    ...
    {
        return new MonoBehaviourAdapter(appdomain, instance);
    }
}
